...
<head>
    ...
    <link rel="stylesheet" href="__SHOP_CSS__/bootstrap.min.css">
    <link rel="stylesheet" href="__SHOP_CSS__/oneui.css">
    <link rel="stylesheet" href="__SHOP_CSS__/dolphin.css">
    <!-- END Stylesheets -->
</head>
<body>
<!-- Error Content -->
