...
use app\shop\model\Packet as PacketModel;

/**
 * 数据包控制器
 * @package app\shop\controller
 */
class Packet extends Shop
{
    /**
     * 首页
    ...
    public function install($name = '')
    {
        ...
        action_shop_log('packet_install', 'shop_packet', 0, UID, implode('、', $packet_titles));
        $this->success('安装成功');
    }
    ...
    public function uninstall($name = '')
    {
        ...
        // 记录行为
        $packet_titles = PacketModel::where('name', 'in', $names)->column('title');
        action_shop_log('packet_uninstall', 'shop_packet', 0, UID, implode('、', $packet_titles));
