...
class Config extends Shop
{
    ...
    public function add($group = '')
    {
        ...
        if ($this->request->isPost()) {
            ...
            if ($config = ConfigModel::create($data)) {
                ...
                action_shop_log('config_add', 'shop_config', $config['id'], UID, $details);
    ...
    public function edit($id = 0)
    {
        ...
        if ($this->request->isPost()) {
            ...
            if ($config = ConfigModel::update($data)) {
                ...
                $forward = $this->request->param('_pop') == 1 ? null : cookie('__forward__');
                // 记录行为
                action_shop_log('config_edit', 'shop_config', $config['id'], UID, $details);
    ...
    public function setStatus($type = '', $record = [])
    {
        ...
        return parent::setStatus($type, ['config_'.$type, 'shop_config', $uid_delete, UID, implode('、', $ids)]);
    }
    ...
    public function quickEdit($record = [])
    {
        ...
        return parent::quickEdit(['config_edit', 'shop_config', $id, UID, $details]);
    }
}