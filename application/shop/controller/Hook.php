...
use app\shop\model\HookPlugin;
use app\common\builder\ZBuilder;
use app\shop\model\Hook as HookModel;
use app\shop\model\HookPlugin as HookPluginModel;

/**
 * 钩子控制器
 * @package app\shop\controller
 */
class Hook extends Shop
{
    /**
     * 钩子管理
     * @author zg
    ...
    public function add()
    {
        ...
        if ($this->request->isPost()) {
            ...
            if ($hook = HookModel::create($data)) {
                ...
                // 记录行为
                action_shop_log('hook_add', 'shop_hook', $hook['id'], UID, $data['name']);
    ...
    public function edit($id = 0)
    {
        ...
        if ($this->request->isPost()) {
            ...
            if ($hook = HookModel::update($data)) {
                ...
                cache('hook_plugins', null);
                // 记录行为
                action_shop_log('hook_edit', 'shop_hook', $hook['id'], UID, $data['name']);
    ...
    public function quickEdit($status = '')
    {
        ...
        return parent::quickEdit(['hook_edit', 'shop_hook', $id, UID, $details]);
    }
    ...
    public function setStatus($type = '', $record = [])
    {
        ...
        return parent::setStatus($type, ['hook_'.$type, 'shop_hook', $hook_delete, UID, implode('、', $hook_names)]);
    }
}
